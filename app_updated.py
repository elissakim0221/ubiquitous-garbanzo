...
SECTION_ORDER = ["Thruster Performance", "Scaling Law Inputs", "Ionization Inputs", "Placeholder values -- please verify"]
...
if DEFAULTS["ionization_cross_section"]["placeholder"]:
    st.warning(
        "The ionization cross-section is still a placeholder value. Mean-free-path outputs are not "
        "trustworthy until you replace it with the cross-section you intend to use.",
        icon="\u26a0\ufe0f",
    )
...
The ionization cross-section is still set to a placeholder value of `1e-19 m^2`. Replace it with the
value/correlation you want before relying on the mean-free-path or 99% ionization-length results.
